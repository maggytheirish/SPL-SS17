...
list.of.packages = c("rpart","lubridate","outliers","rpart.plot", "xgboost",
                      ...
                      "car","devtools","yamldebugger","mlbench","Hmisc", "ggvis","relaimpo", "formatR","data.table", "zoo", "ggplot2", "forecast", "reshape2", "pdp")
...
varlist = c("StoreType", "Assortment", "Promo2","DayOfWeek", "Open", "Promo", "StateHoliday", "SchoolHoliday", "PromoInterval")
