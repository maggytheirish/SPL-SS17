...
list.of.packages <- c("rpart","lubridate","outliers","rpart.plot", "xgboost",
                      ...
                      "car","devtools","yamldebugger","mass", "relaimpo")
...
#Test set
test_set$CompetitionDistance[is.na(test_set$CompetitionDistance)] <- mean(test_set$CompetitionDistance, na.rm = TRUE)
test_set$Promo2SinceDate[is.na(test_set$Promo2SinceDate)] <- mean(test_set$Promo2SinceDate, na.rm = TRUE)
test_set$CompetitionSinceDate[is.na(test_set$CompetitionSinceDate)] <- mean(test_set$CompetitionSinceDate, na.rm = TRUE)     
```
